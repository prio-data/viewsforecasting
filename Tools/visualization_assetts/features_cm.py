...
top10_sb= give_me_topX_country_id_cumulative(df=features_cm, time_index = 'month_id', number_wanted = 10,
                                               variable = 'ged_sb_ln1', start = 109, end = EndOfHistory, variable_transformation = 'ln1')
top10_ns = give_me_topX_country_id_cumulative(df=features_cm, time_index = 'month_id', number_wanted = 10,
                                               variable = 'ged_ns_ln1', start = 109, end = EndOfHistory, variable_transformation = 'ln1')
top10_os = give_me_topX_country_id_cumulative(df=features_cm, time_index = 'month_id', number_wanted = 10,
                                               variable = 'ged_os_ln1', start = 109, end = EndOfHistory, variable_transformation = 'ln1')

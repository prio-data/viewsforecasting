...
qs_topics_stub = (Queryset("fatalities002_topics_stub", "country_month")
    ...
    .with_column(Column('splag_topic1_religion_t1_stock', from_table='topic_cm', from_column = 'topic_religion') 
                .transform.missing.fill()
                .transform.missing.replace_na()
                .transform.temporal.tlag(1)
                .transform.missing.fill()
    ...
    .with_column(Column('splag_topic2_politics_t1_stock', from_table='topic_cm', from_column = 'topic_politics') 
                .transform.missing.fill()
                .transform.missing.replace_na()
                .transform.temporal.tlag(1)
                .transform.missing.fill()
    ...
    .with_column(Column('splag_topic4_energy_t1_stock', from_table='topic_cm', from_column = 'topic_energy') 
                .transform.missing.fill()
                .transform.missing.replace_na()
                .transform.temporal.tlag(1)
                .transform.missing.fill()
    ...
    .with_column(Column('splag_topic5_media_t1_stock', from_table='topic_cm', from_column = 'topic_media') 
                .transform.missing.fill()
                .transform.missing.replace_na()
                .transform.temporal.tlag(1)
                .transform.missing.fill()
    ...
    .with_column(Column('splag_topic6_economics_t1_stock', from_table='topic_cm', from_column = 'topic_economics') 
                .transform.missing.fill()
                .transform.missing.replace_na()
                .transform.temporal.tlag(1)
                .transform.missing.fill()
    ...
    .with_column(Column('splag_topic7_health_t1_stock', from_table='topic_cm', from_column = 'topic_health') 
                .transform.missing.fill()
                .transform.missing.replace_na()
                .transform.temporal.tlag(1)
                .transform.missing.fill()
    ...
    .with_column(Column('splag_topic8_china_t1_stock', from_table='topic_cm', from_column = 'topic_china') 
                .transform.missing.fill()
                .transform.missing.replace_na()
                .transform.temporal.tlag(1)
                .transform.missing.fill()
    ...
    .with_column(Column('splag_topic9_foreign_t1_stock', from_table='topic_cm', from_column = 'topic_foreign') 
                .transform.missing.fill()
                .transform.missing.replace_na()
                .transform.temporal.tlag(1)
                .transform.missing.fill()
    ...
    .with_column(Column('splag_topic10_conflict_t1_stock', from_table='topic_cm', from_column = 'topic_conflict') 
                .transform.missing.fill()
                .transform.missing.replace_na()
                .transform.temporal.tlag(1)
                .transform.missing.fill()
    ...
    .with_column(Column('splag_topic11_diplomacy_t1_stock', from_table='topic_cm', from_column = 'topic_diplomacy') 
                .transform.missing.fill()
                .transform.missing.replace_na()
                .transform.temporal.tlag(1)
                .transform.missing.fill()
    ...
    .with_column(Column('splag_topic12_power_t1_stock', from_table='topic_cm', from_column = 'topic_power') 
                .transform.missing.fill()
                .transform.missing.replace_na()
                .transform.temporal.tlag(1)
                .transform.missing.fill()
    ...
    .with_column(Column('splag_topic13_sports_t1_stock', from_table='topic_cm', from_column = 'topic_sports') 
                .transform.missing.fill()
                .transform.missing.replace_na()
                .transform.temporal.tlag(1)
                .transform.missing.fill()
    ...
    .with_column(Column('splag_topic14_judiciary_t1_stock', from_table='topic_cm', from_column = 'topic_judiciary') 
                .transform.missing.fill()
                .transform.missing.replace_na()
                .transform.temporal.tlag(1)
                .transform.missing.fill()
...
qs_joint_narrow = (Queryset("fatalities002_joint_narrow", "country_month")
 ...
 #
    ...
    # Spatial lags [hh20]
    .with_column(Column("splag_ste_theta11_stock", from_table='topic_cm', from_column = 'topic_diplomacy') 
                .transform.missing.fill()
                .transform.missing.replace_na()
                .transform.temporal.tlag(1)
                .transform.missing.fill()
    ...
    .with_column(Column("splag_ste_theta2_stock", from_table = "topic_cm", from_column = "topic_sanctions")
                .transform.missing.fill()
                .transform.missing.replace_na()
                .transform.temporal.tlag(1)
                .transform.missing.fill()
...
qs_joint_broad_stub = (Queryset("fatalities002_joint_broad_stub", "country_month")
    ...
    .with_column(Column('splag_topic2_sanctions_t1_stock', from_table='topic_cm', from_column = 'topic_sanctions') 
                .transform.missing.fill()
                .transform.missing.replace_na()
                .transform.temporal.tlag(1)
                .transform.missing.fill()

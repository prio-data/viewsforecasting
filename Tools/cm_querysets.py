...
def get_cm_querysets():
    ...
    # log variables
    qs_vdem_escwa = (Queryset("escwa001_vdem", "country_month")
                   # target variable
                   .with_column(Column("ged_sb_dep", from_table="ged2_cm", from_column="ged_sb_best_sum_nokgi")
                                .transform.bool.gte(25)
                                .transform.missing.fill()
                          ...
                          .describe("""Predicting >25, cm level
                                    ...
                                    Queryset with cy features from vdem
     
                                    """)
                          )

    data = qs_vdem_escwa.publish().fetch()

    print(f"escwa001_vdem "
...
#################################################################################################################################
    ...
    qs_topics_stub = (Queryset("fatalities002_topics_stub", "country_month")
                      ...
                      #Topic, tokens
                      .with_column(Column('topic_tokens_t1', from_table='topic2_cm', from_column='topic_tokens')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(1)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_tokens_t2', from_table='topic2_cm', from_column='topic_tokens')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(2)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_tokens_t13', from_table='topic2_cm', from_column='topic_tokens')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                      ...
                      .with_column(Column('topic_tokens_t1_splag', from_table='topic2_cm', from_column='topic_tokens')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(13)
                                   .transform.missing.fill()
                      ...
                      # Topic 0
                      .with_column(Column('topic_ste_theta0_stock_t1', from_table='topic2_cm', from_column='topic_ste_theta0_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(1)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta0_stock_t2', from_table='topic2_cm', from_column='topic_ste_theta0_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(2)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta0_stock_t13', from_table='topic2_cm', from_column='topic_ste_theta0_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(13)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta0_stock_t1_splag', from_table='topic2_cm', from_column='topic_ste_theta0_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(13)
                                   .transform.missing.fill()
                       ...
                       # Topic 1
                      .with_column(Column('topic_ste_theta1_stock_t1', from_table='topic2_cm', from_column='topic_ste_theta1_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(1)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta1_stock_t2', from_table='topic2_cm', from_column='topic_ste_theta1_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(2)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta1_stock_t13', from_table='topic2_cm', from_column='topic_ste_theta1_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(13)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta1_stock_t1_splag', from_table='topic2_cm', from_column='topic_ste_theta1_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(13)
                                   .transform.missing.fill()
                      ...
                      # Topic 2
                      .with_column(Column('topic_ste_theta2_stock_t1', from_table='topic2_cm', from_column='topic_ste_theta2_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(1)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta2_stock_t2', from_table='topic2_cm', from_column='topic_ste_theta2_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(2)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta2_stock_t13', from_table='topic2_cm', from_column='topic_ste_theta2_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(13)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta2_stock_t1_splag', from_table='topic2_cm', from_column='topic_ste_theta2_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(13)
                                   .transform.missing.fill()
                      ...
                      # Topic 3
                      .with_column(Column('topic_ste_theta3_stock_t1', from_table='topic2_cm', from_column='topic_ste_theta3_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(1)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta3_stock_t2', from_table='topic2_cm', from_column='topic_ste_theta3_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(2)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta3_stock_t13', from_table='topic2_cm', from_column='topic_ste_theta3_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(13)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta3_stock_t1_splag', from_table='topic2_cm', from_column='topic_ste_theta3_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(13)
                                   .transform.missing.fill()
                      ...
                      # Topic 4
                      .with_column(Column('topic_ste_theta4_stock_t1', from_table='topic2_cm', from_column='topic_ste_theta4_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(1)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta4_stock_t2', from_table='topic2_cm', from_column='topic_ste_theta4_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(2)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta4_stock_t13', from_table='topic2_cm', from_column='topic_ste_theta4_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(13)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta4_stock_t1_splag', from_table='topic2_cm', from_column='topic_ste_theta4_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(13)
                                   .transform.missing.fill()
                      ...
                      # Topic 5
                      .with_column(Column('topic_ste_theta5_stock_t1', from_table='topic2_cm', from_column='topic_ste_theta5_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(1)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta5_stock_t2', from_table='topic2_cm', from_column='topic_ste_theta5_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(2)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta5_stock_t13', from_table='topic2_cm', from_column='topic_ste_theta5_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(13)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta5_stock_t1_splag', from_table='topic2_cm', from_column='topic_ste_theta5_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(13)
                                   .transform.missing.fill()
                      ...
                      # Topic 6
                      .with_column(Column('topic_ste_theta6_stock_t1', from_table='topic2_cm', from_column='topic_ste_theta6_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(1)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta6_stock_t2', from_table='topic2_cm', from_column='topic_ste_theta6_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(2)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta6_stock_t13', from_table='topic2_cm', from_column='topic_ste_theta6_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(13)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta6_stock_t1_splag', from_table='topic2_cm', from_column='topic_ste_theta6_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(13)
                                   .transform.missing.fill()
                      ...
                      # Topic 7
                      .with_column(Column('topic_ste_theta7_stock_t1', from_table='topic2_cm', from_column='topic_ste_theta7_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(1)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta7_stock_t2', from_table='topic2_cm', from_column='topic_ste_theta7_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(2)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta7_stock_t13', from_table='topic2_cm', from_column='topic_ste_theta7_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(13)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta7_stock_t1_splag', from_table='topic2_cm', from_column='topic_ste_theta7_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(13)
                                   .transform.missing.fill()
                      ...
                      # Topic 8
                      .with_column(Column('topic_ste_theta8_stock_t1', from_table='topic2_cm', from_column='topic_ste_theta8_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(1)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta8_stock_t2', from_table='topic2_cm', from_column='topic_ste_theta8_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(2)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta8_stock_t13', from_table='topic2_cm', from_column='topic_ste_theta8_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(13)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta8_stock_t1_splag', from_table='topic2_cm', from_column='topic_ste_theta8_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(13)
                                   .transform.missing.fill()
                      ...
                      # Topic 9
                      .with_column(Column('topic_ste_theta9_stock_t1', from_table='topic2_cm', from_column='topic_ste_theta9_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(1)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta9_stock_t2', from_table='topic2_cm', from_column='topic_ste_theta9_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(2)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta9_stock_t13', from_table='topic2_cm', from_column='topic_ste_theta9_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(13)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta9_stock_t1_splag', from_table='topic2_cm', from_column='topic_ste_theta9_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(13)
                                   .transform.missing.fill()
                      ...
                      # Topic 10
                      .with_column(Column('topic_ste_theta10_stock_t1', from_table='topic2_cm', from_column='topic_ste_theta10_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(1)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta10_stock_t2', from_table='topic2_cm', from_column='topic_ste_theta10_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(2)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta10_stock_t13', from_table='topic2_cm', from_column='topic_ste_theta10_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(13)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta10_stock_t1_splag', from_table='topic2_cm', from_column='topic_ste_theta10_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(13)
                                   .transform.missing.fill()
                      ...
                      # Topic 11
                      .with_column(Column('topic_ste_theta11_stock_t1', from_table='topic2_cm', from_column='topic_ste_theta11_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(1)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta11_stock_t2', from_table='topic2_cm', from_column='topic_ste_theta11_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(2)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta11_stock_t13', from_table='topic2_cm', from_column='topic_ste_theta11_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(13)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta11_stock_t1_splag', from_table='topic2_cm', from_column='topic_ste_theta11_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(13)
                                   .transform.missing.fill()
                      ...
                      # Topic 12
                      .with_column(Column('topic_ste_theta12_stock_t1', from_table='topic2_cm', from_column='topic_ste_theta12_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(1)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta12_stock_t2', from_table='topic2_cm', from_column='topic_ste_theta12_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(2)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta12_stock_t13', from_table='topic2_cm', from_column='topic_ste_theta12_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(13)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta12_stock_t1_splag', from_table='topic2_cm', from_column='topic_ste_theta12_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(13)
                                   .transform.missing.fill()
                      ...
                      # Topic 13
                      .with_column(Column('topic_ste_theta13_stock_t1', from_table='topic2_cm', from_column='topic_ste_theta13_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(1)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta13_stock_t2', from_table='topic2_cm', from_column='topic_ste_theta13_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(2)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta13_stock_t13', from_table='topic2_cm', from_column='topic_ste_theta13_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(13)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta13_stock_t1_splag', from_table='topic2_cm', from_column='topic_ste_theta13_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(13)
                                   .transform.missing.fill()
                      ...
                      # Topic 14
                      .with_column(Column('topic_ste_theta14_stock_t1', from_table='topic2_cm', from_column='topic_ste_theta14_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(1)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta14_stock_t2', from_table='topic2_cm', from_column='topic_ste_theta14_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(2)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta14_stock_t13', from_table='topic2_cm', from_column='topic_ste_theta14_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(13)
                                   .transform.missing.fill()
                      ...
                      .with_column(Column('topic_ste_theta14_stock_t1_splag', from_table='topic2_cm', from_column='topic_ste_theta14_stock')
                                   .transform.missing.fill()
                                   .transform.missing.replace_na()
                                   .transform.temporal.tlag(13)
                                   .transform.missing.fill()
    ...
    qs_aquastat_stub = (Queryset("fatalities002_aquastat_stub", "country_month")
                        ...
                        .with_column(Column('ind_efficiency_t48', from_table='fao_aqua_cy',
                                            from_column='ind_efficiency')
                                     .transform.missing.fill()
                                     .transform.missing.replace_na()
                                     .transform.temporal.tlag(48)
                        ...
                        .with_column(Column('irr_agr_efficiency_t48', from_table='fao_aqua_cy',
                                            from_column='irr_agr_efficiency')
                                     .transform.missing.fill()
                                     .transform.missing.replace_na()
                                     .transform.temporal.tlag(48)
                        ...
                        .with_column(Column('services_efficiency_t48', from_table='fao_aqua_cy',
                                            from_column='services_efficiency')
                                     .transform.missing.fill()
                                     .transform.missing.replace_na()
                                     .transform.temporal.tlag(48)
    ...
    qs_conflict_stub = (Queryset("fatalities002_cm_conflict_history_stub", "country_month")
                        ...
                        .with_column(Column("decay_ged_sb_100", from_table="ged2_cm",
                                            from_column="ged_sb_best_sum_nokgi")
                                     .transform.missing.replace_na()
                                     .transform.bool.gte(100)
                                     .transform.temporal.time_since()
                        ...
                        .with_column(Column("decay_ged_os_100", from_table="ged2_cm",
                                            from_column="ged_os_best_sum_nokgi")
                                     .transform.missing.replace_na()
                                     .transform.bool.gte(100)
                                     .transform.temporal.time_since()
                        ...
                        # ns
                        .with_column(Column("decay_ged_ns_5", from_table="ged2_cm",
                                            from_column="ged_ns_best_sum_nokgi")
                                     .transform.missing.replace_na()
                                     .transform.bool.gte(5)
                                     .transform.temporal.time_since()
                        ...
                        .with_column(Column("decay_ged_ns_100", from_table="ged2_cm",
                                            from_column="ged_ns_best_sum_nokgi")
                                     .transform.missing.replace_na()
                                     .transform.bool.gte(100)
                                     .transform.temporal.time_since()
                        ...
                        .with_column(Column("ln_ged_os_tlag_1", from_table="ged2_cm",
                                            from_column="ged_os_best_sum_nokgi")
                                     .transform.ops.ln()
                                     .transform.missing.fill()
                                     .transform.temporal.tlag(1)
                        ...
                        .with_column(Column("splag_1_decay_ged_os_5", from_table="ged2_cm",
                                            from_column="ged_os_best_sum_nokgi")
                                     .transform.missing.replace_na()
                                     .transform.bool.gte(5)
                                     .transform.temporal.time_since()
                        ...
                        .with_column(Column("splag_1_decay_ged_ns_5", from_table="ged2_cm",
                                            from_column="ged_ns_best_sum_nokgi")
                                     .transform.missing.replace_na()
                                     .transform.bool.gte(5)
                                     .transform.temporal.time_since()
    ...
    qs_conflict_ext = (Queryset("fatalities002_cm_conflict_history_ext", "country_month")
                       ...
                       .with_column(Column("ln_ged_sb_tsum_48", from_table="ged2_cm",
                                           from_column="ged_sb_best_sum_nokgi")
                                    .transform.missing.replace_na()
                       ...
                       .with_column(Column("decay_ged_os_500", from_table="ged2_cm",
                                           from_column="ged_os_best_sum_nokgi")
                                    .transform.missing.replace_na()
                                    .transform.bool.gte(500)
                                    .transform.temporal.time_since()
                       ...
                       # ns
                       .with_column(Column("decay_ged_ns_1", from_table="ged2_cm",
                                           from_column="ged_ns_best_sum_nokgi")
                                    .transform.missing.replace_na()
                                    .transform.bool.gte(1)
                                    .transform.temporal.time_since()
                       ...
                       .with_column(Column("decay_ged_ns_500", from_table="ged2_cm",
                                           from_column="ged_ns_best_sum_nokgi")
                                    .transform.missing.replace_na()
                                    .transform.bool.gte(500)
                                    .transform.temporal.time_since()
                       ...
                       # time-lagged by 0-2 independent variables
                       .with_column(Column("ln_ged_ns_tlag_1", from_table="ged2_cm",
                                           from_column="ged_ns_best_sum_nokgi")
                                    .transform.ops.ln()
                                    .transform.missing.fill()
                                    .transform.temporal.tlag(1)
    ...
    qs_wdi_short_stub = (Queryset("fatalities002_wdi_short_stub", "country_month")
                         ...
                         # Spatial lags
                         .with_column(Column("splag_wdi_sl_tlf_totl_fe_zs", from_table="wdi_cy",
                                             from_column="wdi_sl_tlf_totl_fe_zs")
                                      .transform.missing.fill()
                                      .transform.temporal.tlag(12)
                                      .transform.spatial.countrylag(1, 1, 0, 0)
                         ...
                         .with_column(Column("splag_wdi_sm_pop_refg_or", from_table="wdi_cy",
                                             from_column="wdi_sm_pop_refg_or")
                                      .transform.missing.fill()
                                      .transform.temporal.tlag(12)
                                      .transform.spatial.countrylag(1, 1, 0, 0)
                         ...
                         .with_column(Column("splag_wdi_sm_pop_netm", from_table="wdi_cy",
                                             from_column="wdi_sm_pop_netm")
                                      .transform.missing.fill()
                                      .transform.temporal.tlag(12)
                                      .transform.spatial.countrylag(1, 1, 0, 0)
                         ...
                         .with_column(Column("splag_wdi_ag_lnd_frst_k2", from_table="wdi_cy",
                                             from_column="wdi_ag_lnd_frst_k2")
                                      .transform.missing.fill()
                                      .transform.temporal.tlag(12)
                                      .transform.spatial.countrylag(1, 1, 0, 0)
    ...
    qs_joint_broad_stub = (Queryset("fatalities002_joint_broad_stub", "country_month")
                           ...
                           .with_column(Column("decay_ged_sb_5", from_table="ged2_cm",
                                               from_column="ged_sb_best_sum_nokgi")
                                        .transform.missing.replace_na()
                                        .transform.bool.gte(5)
                                        .transform.temporal.time_since()
                           ...
                           .with_column(Column("decay_ged_os_5", from_table="ged2_cm",
                                               from_column="ged_os_best_sum_nokgi")
                                        .transform.missing.replace_na()
                                        .transform.bool.gte(5)
                                        .transform.temporal.time_since()
    ...
    qs_faoprices_stub = (Queryset("fatalities002_faoprices_stub", "country_month")
                         ...
                         .with_column(Column("delta_fao_wheat_price", from_table="faostat_pp_cm",
                         ...
                         .with_column(Column("delta_fao_sugar_price", from_table="faostat_pp_cm",
                         ...
                         .with_column(Column("delta_fao_meat_price", from_table="faostat_pp_cm",
                         ...
                         .with_column(Column("delta_fao_milk_price", from_table="faostat_pp_cm",
